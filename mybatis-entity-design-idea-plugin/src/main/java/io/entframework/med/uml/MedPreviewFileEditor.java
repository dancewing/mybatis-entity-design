...
final class MedPreviewFileEditor extends UserDataHolderBase implements FileEditor {
    ...
    private @Nullable MedDiagramPanel myPanel;

    private final MergingUpdateQueue mergingUpdateQueue = new MergingUpdateQueue("MED", RENDERING_DELAY_MS, true, null,
            this);
    ...
    public MedPreviewFileEditor(@NotNull Project project, @NotNull VirtualFile file) {
        myProject = project;
        myFile = file;
    ...
    private void updateUml() {
        ...
        mergingUpdateQueue.queue(new Update("MED.REDRAW") {
            @Override
            public void run() {

...
public class ClassChooserField extends ComponentWithBrowseButton<EditorTextField> {
    ...
    public ClassChooserField(@NotNull Project myProject) {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            if (source instanceof FixedSizeButton fixedSizeButton) {
                if (fixedSizeButton.getParent() != null
                        && fixedSizeButton.getParent() instanceof ClassChooserField host) {
                    ...
                    final TreeClassChooser chooser = TreeClassChooserFactory.getInstance(myProject)
                            .createInheritanceClassChooser("Choose class", ProjectScope.getAllScope(myProject), null,
                                    fromClass);
                    chooser.showDialog();

                    final PsiClass result = chooser.getSelected();
                    if (result != null) {
                        host.setText(result.getQualifiedName());
                    }

...
public class NotifyUtil {
    ...
    private final static NotificationGroup GROUP_DISPLAY_ID_INFO = new NotificationGroup("CodeGen notification group",
            NotificationDisplayType.BALLOON, true);

    public static void notice(String title, String content, MessageType type) {
        Notification notification = GROUP_DISPLAY_ID_INFO.createNotification(title, content, type.toNotificationType(),
                null);

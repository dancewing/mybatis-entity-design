...
public class StringUtils {
    ...
    /**
     * Check that the given CharSequence is neither {@code null} nor of length 0. Note:
     * Will return {@code true} for a CharSequence that purely consists of whitespace.
     * <p>
     * <pre class="code">
    ...
    /**
     * Check that the given String is neither {@code null} nor of length 0. Note: Will
     * return {@code true} for a String that purely consists of whitespace.
     *
     ...
     * {@code true} if the string not {@code null}, its length is greater than 0, and it
     ...
     *
     * @param str the CharSequence to check (may be {@code null})
     * @return {@code true} if the CharSequence is not {@code null}, its length is greater
     ...
     *
     * @param str the String to check (may be {@code null})
     * @return {@code true} if the String is not {@code null}, its length is greater than
     ...
     *
     * @param str the String to check (may be {@code null})
     * @return {@code true} if the String is not empty and contains at least 1 whitespace
     * character
     ...
     * @return the quoted String (e.g. "'myString'"), or {@code null} if the input was
     * {@code null}
     */
    ...
    /**
     * Turn the given Object into a String with single quotes if it is a String; keeping
     * the Object as-is else.
     *
     * @param obj the input Object (e.g. "myString")
     * @return the quoted String (e.g. "'myString'"), or the input object as-is if not a
     * String
     */
    ...
    /**
     * Apply the given relative path to the given path, assuming standard Java folder
     ...
     *                     {@code toString()} format ("en", "en_UK", etc); also accepts spaces as separators,
    ...
    /**
     * Copy the given Collection into a String array. The Collection must contain String
     * elements only.
     *
    ...
    /**
     * Copy the given Enumeration into a String array. The Enumeration must contain String
     * elements only.
     *
    ...
    /**
     * Tokenize the given String into a String array via a StringTokenizer. Trims tokens
     * and omits empty tokens.
     * <p>
     ...
     * considered as single delimiter string, rather than as bunch of potential delimiter
     * characters - in contrast to {@code tokenizeToStringArray}.
     *
